        ...
        <Columns.Column>
          <Card style={{ width: 300, margin: 'auto' }}>
            ...
            <Card.Content >
              ...
              <a href="https://drive.google.com/file/d/1UIBQ941WK78PqER-6nHmsZf4pCOaR37a/view" target="_blank" rel="noopener noreferrer" id='cardtitle' className=' is-size-3 has-text-black'> PROJECTS MANAGEMENT PORTAL</a>
              ...
              <p id='cardbody' className="is-size-5 has-text-black">
                ...
                <a id="cardlink" href="https://drive.google.com/file/d/1UIBQ941WK78PqER-6nHmsZf4pCOaR37a/view" target="_blank" rel="noopener noreferrer">Click here</a> for a
                short video of its functionalities and <a id="cardlink"
                  href="https://github.com/Nico749/GraphQL_Projects_Manage" target="_blank" rel="noopener noreferrer">here for the GitHub</a> repo!<br></br>
                Built with:
                <ul className='techlist'>
                  <li className='tech'>- React</li><br></br>
